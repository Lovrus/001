 ...
 */
public class Ball20 extends BaseObject20 {
    //скорость
    ...
    public Ball20(double x, double y, double speed, double direction) {
        super(x, y, 1);
    ...
    public void move() {
        ...
        checkRebound(1, Arkanoid20.game.getWidth(), 1, Arkanoid20.game.getHeight() + 5);
    }
