 ...
 */
public abstract class BaseObject20 {
    //координаты
    protected double x;
    protected double y;
    //радиус объекта
    ...
    protected BaseObject20(double x, double y, double radius) {
        this.x = x;
        this.y = y;
        this.radius = radius;
    }
     ...
     */
    abstract void draw(Canvas20 canvas);
     ...
     */
    boolean intersects(BaseObject20 o) {
        double dx = x - o.x;
        double dy = y - o.y;
