...
public class JR_7_6_2 {
    ...
    public static void printCityPopulation(String city, double population){
        ...
        System.out.println("В то время как в самом густонаселенном городе " + JR_7_6_2.city + " население составляет " + JR_7_6_2.population + " млн человек.");
    }
}
