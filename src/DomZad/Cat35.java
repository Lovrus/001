 ...
 */
public class Cat35 implements Pet2 {
    private String name;

    public Cat35(String name) {
        this.name = name;
    }
    ...
    public Sayable toSayable(final int i) {
        class CatPet implements Sayable {
            ...
            public String say() {
                if (i < 1)
                    return Cat35.this.name + " спит.";

                StringBuilder sb = new StringBuilder(Cat35.this.name).append(" говорит м");
                for (int j = 0; j < i; j++)
                    sb.append("я");
                sb.append("у!");
                return sb.toString();
